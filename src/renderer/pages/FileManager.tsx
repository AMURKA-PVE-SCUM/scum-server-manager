  ...
  return (
    <Box>
      ...
      <Dialog open={!!editFile} onClose={() => setEditFile(null)} maxWidth="lg" fullWidth>
        ...
        <DialogContent>
          <Box component="textarea" value={editContent} onChange={(e) => setEditContent(e.target.value)} sx={{ width: '100%', minHeight: 400, fontFamily: 'monospace', fontSize: 13, p: 2, bgcolor: '#000000', color: '#e6edf3', border: '1px solid #30363d', borderRadius: 1, mt: 2 }} />
        </DialogContent>
