    ...
    <Box>
      ...
      <Card><CardContent>
        <Box component="textarea" value={data} onChange={(e) => setData(e.target.value)}
          sx={{ width: '100%', minHeight: 400, fontFamily: 'monospace', fontSize: 13, p: 2, bgcolor: '#000000', color: '#e6edf3', border: '1px solid #30363d', borderRadius: 1, resize: 'vertical', '&:focus': { outline: 'none', borderColor: '#58a6ff' } }} />
