      ...
      {selected && (
        <Card><CardContent>
          <Box component="textarea" value={content} onChange={(e) => setContent(e.target.value)}
            sx={{ width: '100%', minHeight: 500, fontFamily: 'monospace', fontSize: 13, p: 2, bgcolor: '#000000', color: '#e6edf3', border: '1px solid #30363d', borderRadius: 1, resize: 'vertical', '&:focus': { outline: 'none', borderColor: '#58a6ff' } }} />
